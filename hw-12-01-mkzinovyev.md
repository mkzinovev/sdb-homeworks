...
## Задание 1. Проектирование модели данных по Excel-отчёту
...
Схема базы данных вынесена в отдельный файл: `company_db_schema.png`.

Для сдачи задания можно вставить в `README.md` скриншот этой схемы.
